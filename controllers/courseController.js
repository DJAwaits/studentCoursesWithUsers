...
module.exports.enrollStudent = async function(req, res){
    ...
    const profileBeLongToUser = req.user.can('enroll self') && req.user.matchesStudentId(req.body.student);
...
module.exports.removeStudent = async function(req, res){
    ...
    const profileBeLongToUser = req.user.can('drop self') && req.user.matchesStudentId(req.params.studentId);
