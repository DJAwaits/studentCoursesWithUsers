...
module.exports.viewProfile = async function (req, res) {
    ...
    const profileBeLongToUser = req.user.can('view self') && req.user.matchesStudentId(req.params.id);

    //if they aren't staff and they aren't the student whose profile they are trying to view, redirect
    if (!isAdmin && !profileBeLongToUser){
        res.redirect('/')
        return
    }
...
module.exports.renderEditForm = async function (req, res) {
    ...
    const profileBeLongToUser = req.user.can('edit self') && req.user.matchesStudentId(req.params.id);
...
module.exports.enrollStudent = async function (req, res) {
    ...
    const profileBeLongToUser = req.user.can('enroll self') && req.user.matchesStudentId(req.params.id);
...
module.exports.removeCourse = async function(req, res){
    ...
    const profileBeLongToUser = req.user.can('drop self') && req.user.matchesStudentId(req.params.id);
